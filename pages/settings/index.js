        ...
        <div className={`${styles.card} ${styles.profileCard}`.trim()}>
          ...
          <div style={{ marginTop: 10 }}>
            <div className={styles.kv}>
              ...
              <div className={styles.v}>{p?.name || "—"}</div>
            </div>
            <div className={styles.kv}>
        ...
        <div className={styles.page}>
          <div className={`${styles.card} ${styles.headerRow}`.trim()}>
            <div className={styles.titleBlock}>
              ...
              <p className={styles.subtitle}>Manage your profile, credits, subscription, and tool history.</p>
            </div>

            <div className={styles.tabBar}>
              <button
                type="button"
                className={`${styles.tab} ${activeMainTab === "profile" ? styles.tabActive : ""}`.trim()}
              ...
              <button
                type="button"
                className={`${styles.tab} ${activeMainTab === "history" ? styles.tabActive : ""}`.trim()}
          ...
          <div className={styles.card}>
            {activeMainTab === "profile" ? renderProfileTab() : renderHistoryTab()}
          </div>
        </div>
      </DashboardLayout>
    </>
