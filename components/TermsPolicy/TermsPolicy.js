        ...
        <div className="rbt-dashboard-content rainbow-section-gap">
          <div className="banner-area">
            <div className="settings-area">
              <h1 className="title" style={{ fontSize: '42px', fontWeight: '700', color: '#f8fafc', marginBottom: '10px' }}>Terms and Conditions</h1>
          ...
          <div className="content-page pb--50" style={{ marginTop: '40px' }}>
            <div style={styles.card}>
              <div style={styles.section}>
                <p style={styles.text}>
                  By accessing or using Synthovia, you agree to these Terms and Conditions. 
