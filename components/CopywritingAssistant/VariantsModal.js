// components/CopywritingAssistant/VariantsModal.js

import React, { useState } from 'react';

const VariantsModal = ({ variants, onClose, onRequestRegenerate }) => {
  ...
  const handleCopy = async (text, index) => {
    try {
      ...
      console.log(`Variant ${index + 1} copied to clipboard`);
    } catch (err) {
    ...
    <div style={modalStyles.overlay}>
      <div style={modalStyles.modal}>
        <div style={modalStyles.header}>
          <h2 style={modalStyles.title}>Generated Copy Variants ({variants.length})</h2>
          <button
            onClick={onClose}
            style={{
              background: 'none',
        ...
        <div style={modalStyles.body}>
          <p style={{ marginBottom: '20px', color: '#475569', fontSize: '14px' }}>
            Click on any variant to expand and view the full copy. Use the Copy button to copy a variant.
          </p>
