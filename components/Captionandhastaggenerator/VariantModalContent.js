...
/**
 * Renders a modal displaying generated content variants with options to copy or regenerate.
 *
 * @param {Object[]} variants - Array of generated variant objects.
 * @param {Function} onClose - Function to close the modal.
 * @param {Object} inputs - The original form inputs (payload) for context display.
 * @param {Function} onRequestRegenerate - Handler to request regeneration for a specific variant.
 * @param {Function} showNotification - Utility function to display a toast notification.
 */
...
                                >
                                   {/* FIX APPLIED HERE: Use contextLabel derived from existing input properties */}
